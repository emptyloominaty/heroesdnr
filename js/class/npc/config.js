...
let heroesConfig = {
    Warrior: {
        dps:   {dpsSt: 1.5, dpsAoe: 2.1, hpsSt:0.0, hpsAoe:0.0, dtpsP:1.2, dtpsM:0.45, speed: 1.1, hMul: 1.25, fMul: 1.2, escape: 0.28, critFailD: 1.3, femaleR:[50,1]},
    ...
    Rogue: {
        dps:   {dpsSt: 2.85, dpsAoe: 1.5, hpsSt: 0.0, hpsAoe: 0.0, dtpsP: 0.65, dtpsM: 0.8, speed: 1.2, hMul: 1.0, fMul: 1.0, escape: 0.5, critFailD: 0.8, femaleR:[5,1]}},
    Ranger: {
        dps:   {dpsSt: 3.3, dpsAoe: 1.3, hpsSt: 0.02, hpsAoe: 0.0, dtpsP: 0.6, dtpsM: 0.6, speed: 1.15, hMul: 1.1, fMul: 0.95, escape: 0.3, critFailD: 0.9, femaleR:[4,1]}},
    Mage: {
        dps:   {dpsSt: 1.95, dpsAoe: 2.93, hpsSt: 0.05, hpsAoe: 0.05, dtpsP: 0.3, dtpsM: 2.5, speed: 0.9, hMul: 0.8, fMul: 0.85, escape: 0.3, critFailD: 0.85, femaleR: [2, 1]}},
    Druid: {
        dps:   {dpsSt: 1.2, dpsAoe: 2.85, hpsSt: 0.1, hpsAoe: 0.2, dtpsP: 0.6, dtpsM: 2.3, speed: 1.35, hMul: 0.85, fMul: 0.9, escape: 0.35, critFailD: 1, femaleR: [1.2, 1]},
        healer:{dpsSt: 0.1, dpsAoe: 0.45, hpsSt: 1.15, hpsAoe: 1.4, dtpsP: 0.6, dtpsM: 1.0, speed: 1.35, hMul: 0.85, fMul: 0.9, escape: 0.35, critFailD: 1, femaleR: [1, 3.5]},
    ...
    Priest: {
        dps:   {dpsSt: 1.88, dpsAoe: 2.25, hpsSt: 0.25, hpsAoe: 0.25, dtpsP: 0.3, dtpsM: 1.3, speed: 0.95, hMul: 0.9, fMul: 1.0, escape: 0.2, critFailD: 1.2, femaleR: [1.5, 1]},
        healer:{dpsSt: 0.1, dpsAoe: 0.15, hpsSt: 1.3, hpsAoe: 1.35, dtpsP: 0.3, dtpsM: 1.0, speed: 0.95, hMul: 0.9, fMul: 1.0, escape: 0.2, critFailD: 1.2, femaleR: [1, 1.5]}},
    Paladin: {
        dps:   {dpsSt: 1.8, dpsAoe: 2.25, hpsSt: 0.2, hpsAoe: 0.1, dtpsP: 2.0, dtpsM: 1.8, speed: 0.92, hMul: 1.15, fMul: 1.2, escape: 0.22, critFailD: 1.5, femaleR: [35, 1]},
        healer:{dpsSt: 0.4, dpsAoe: 0.6, hpsSt: 1.5, hpsAoe: 1.0, dtpsP: 2.0, dtpsM: 1.0, speed: 0.88, hMul: 1.15, fMul: 1.2, escape: 0.24, critFailD: 1.5, femaleR: [30, 1]},
        tank:  {dpsSt: 0.55, dpsAoe: 0.8, hpsSt: 0.4, hpsAoe: 0.1, dtpsP: 4.0, dtpsM: 4.0, speed: 0.85, hMul: 1.2, fMul: 1.25, escape: 0.24, critFailD: 1.6, femaleR: [80, 1]}},
    Warlock: {
        dps:   {dpsSt: 2.7, dpsAoe: 2.8, hpsSt: 0.0, hpsAoe: 0.0, dtpsP: 0.3, dtpsM: 1.5, speed: 0.9, hMul: 0.95, fMul: 0.9, escape: 0.2, critFailD: 0.5, femaleR: [1, 1]}},
    Shaman: {
        dps:   {dpsSt: 1.8, dpsAoe: 2.55, hpsSt: 0.05, hpsAoe: 0.25, dtpsP: 0.6, dtpsM: 2.0, speed: 0.98, hMul: 1.0, fMul: 0.95, escape: 0.2, critFailD: 1, femaleR: [1, 1]},
        healer:{dpsSt: 0.1, dpsAoe: 0.3, hpsSt: 1.1, hpsAoe: 1.5, dtpsP: 0.6, dtpsM: 1.2, speed: 1.0, hMul: 1.0, fMul: 0.95, escape: 0.2, critFailD: 1, femaleR: [1, 1]}},
