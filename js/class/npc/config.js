...
let heroesConfig = {
    Warrior: {
        dps:   {dpsSt: 1.0, dpsAoe: 1.4, hpsSt:0.0, hpsAoe:0.0, dtpsP:1.2, dtpsM:0.45, speed: 1.1, hMul: 1.25, fMul: 1.2, escape: 0.28, critFailD: 1.3, femaleR:[50,1]},
    ...
    Druid: {
        dps:   {dpsSt: 0.8, dpsAoe: 1.8, hpsSt: 0.1, hpsAoe: 0.2, dtpsP: 0.6, dtpsM: 2.3, speed: 1.35, hMul: 0.85, fMul: 0.9, escape: 0.35, critFailD: 1, femaleR: [1.2, 1]},
        healer:{dpsSt: 0.1, dpsAoe: 0.4, hpsSt: 1.1, hpsAoe: 1.2, dtpsP: 0.6, dtpsM: 1.0, speed: 1.35, hMul: 0.85, fMul: 0.9, escape: 0.35, critFailD: 1, femaleR: [1, 3.5]},
    ...
    Paladin: {
        ...
        healer:{dpsSt: 0.4, dpsAoe: 0.6, hpsSt: 1.4, hpsAoe: 1.0, dtpsP: 2.0, dtpsM: 1.0, speed: 0.88, hMul: 1.15, fMul: 1.2, escape: 0.24, critFailD: 1.5, femaleR: [30, 1]},
        tank:  {dpsSt: 0.55, dpsAoe: 0.8, hpsSt: 0.5, hpsAoe: 0.1, dtpsP: 4.0, dtpsM: 4.0, speed: 0.85, hMul: 1.2, fMul: 1.25, escape: 0.24, critFailD: 1.6, femaleR: [80, 1]}},
    Warlock: {
