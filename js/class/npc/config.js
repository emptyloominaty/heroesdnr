...
let heroesConfig = {
    ...
    Paladin: {
        dps:    {dpsSt: 1.2, dpsAoe: 1.5, hpsSt: 0.2, hpsAoe: 0.1, dtpsP: 2.0, dtpsM: 1.8, speed: 0.92, hMul: 1.15, fMul: 1.2, femaleR: [35, 1]},
        healer: {dpsSt: 0.4, dpsAoe: 0.6, hpsSt: 1.4, hpsAoe: 1.0, dtpsP: 2.0, dtpsM: 1.0, speed: 0.88, hMul: 1.15, fMul: 1.2, femaleR: [30, 1]},
        tank:   {dpsSt: 0.55, dpsAoe: 0.8, hpsSt: 0.5, hpsAoe: 0.1, dtpsP: 4.0, dtpsM: 4.0, speed: 0.85, hMul: 1.2, fMul: 1.25, femaleR: [80, 1]}},
    Warlock: {
        dps:    {dpsSt: 1.7, dpsAoe: 1.8, hpsSt: 0.0, hpsAoe: 0.0, dtpsP: 0.3, dtpsM: 1.5, speed: 0.9, hMul: 0.95, fMul: 0.9, femaleR: [1, 1]}},
    Shaman: {
        dps:    {dpsSt: 1.2, dpsAoe: 1.7, hpsSt: 0.05, hpsAoe: 0.25, dtpsP: 0.6, dtpsM: 2.0, speed: 0.98, hMul: 1.0, fMul: 0.95, femaleR: [1, 1]},
        healer: {dpsSt: 0.1, dpsAoe: 0.2, hpsSt: 1.0, hpsAoe: 1.35, dtpsP: 0.6, dtpsM: 1.2, speed: 1.0, hMul: 1.0, fMul: 0.95, femaleR: [1, 1]}},


    RuneKnight: {
        dps:    {dpsSt: 1.8, dpsAoe: 1.3, hpsSt:0.0, hpsAoe:0.0, dtpsP:2, dtpsM:2, speed: 0.8, hMul: 0.5, fMul: 0.5, femaleR:[50,1]},
        tank:   {dpsSt: 0.9, dpsAoe: 0.6, hpsSt:0, hpsAoe:0.0, dtpsP:5, dtpsM:4.5, speed: 0.75, hMul: 0.5, fMul: 0.5, femaleR:[100,1]}},
}